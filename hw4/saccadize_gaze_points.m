...
% .m file is for hw4 part A. It takes in the eye movement data and plots
% points and lines that follow where the eyes are going. The data is from a
% .csv file and the resulting images are saved in the hw4results folder.
ROW_RES = 1680;
COL_RES = 1050;
GAZECOL_X = 11;
GAZECOL_Y = 12;
...
for fileInd= 1 : size(csvfiles)
    ...
    %Plot lines connecting useful points
    x = x(1:counter);
    y = y(1:counter);
    plot(x, y);
